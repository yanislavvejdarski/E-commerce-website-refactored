                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <form action="/updateCart" method="post">
                                        ...
                                        <input type="submit" name="updateQuantity" class="btn btn-primary"
                                               style="margin-left: 5px;" value="Update">
                                    </form>
                                </div>
                                <h5 class="card-title"><?= $productInfo->price ?> Euro</h5>
                                <div class="row">
                                    <a class="btn btn-primary" href="/removeFromCart/<?= $product["product_id"] ?>"
                                    ...
                                    if ($favoriteDAO->checkIfInFavourites($productInfo->id, $_SESSION["logged_user_id"])) { ?>
                                        <a class="btn btn-primary"
                                           href=/removeFromFavourites/<?= $productInfo->id ?>
                                           role="button" style="margin-left: 5px;">Remove From Favourite</a>
                                    <?php } else {
                                        ?>
                                        <a class="btn btn-primary"
                                           href="/addToFavourites/<?= $productInfo->id ?>" role="button"
                ...
                <div class="card-body">
                    ...
                    if ($addressController->checkUserAddress()) {
                        ...
                        <?php if ($totalprice != 0) { ?>
                            ...
                            <input type="submit" value="Finish Order" name="order" class="btn btn-outline-primary"
                                   style="width: 100%">
                            </form>
                            <?php
                        }
